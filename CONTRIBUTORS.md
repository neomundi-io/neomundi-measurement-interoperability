...
Its purpose is not to demonstrate that the contract is already universally interoperable, but to expose the contract to an independent implementation and document what succeeds, what fails and what needs to evolve.

Richard's contribution therefore belongs to the **implementation and pilot phase** of the project.
