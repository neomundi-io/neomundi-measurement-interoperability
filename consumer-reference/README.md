...
Le JWKS local contient uniquement la clé publique nécessaire pour vérifier indépendamment les signatures Ed25519/JWS des contrats d’exemple.
...
pour les deux contrats publiés.
